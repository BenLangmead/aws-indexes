...
Catalog of genomic indexes freely available from public clouds thanks to the [AWS Open Data Sponsorship Program].  Meant to be viewed as a [GitHub Pages website](https://benlangmead.github.io/aws-indexes/).
